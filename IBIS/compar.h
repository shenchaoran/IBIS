...
c        
      integer 
cc	 >        nlon,    ! longitude dimension of domain
cc     >        nlat,    ! latitude dimension of domain
cc     >        npoi,    ! total number of land points
...
c
      real 
cc	 >     xres,       ! longitude resolution (in degrees)
cc     >     yres,       ! latitude resolution (in degrees)
...
cc      common /compar1/ epsilon, dtime, stef, vonk, grav, tmelt, hfus, hvap, hsub,
cc     >     ch2o,  cice, cair, cvap, rair, rvap, cappa, rhow
	        
c
      real 
     >  garea,   ! area of each gridcell (m**2)
     >  vzero    ! a real array of zeros, of length npoi
c
