...
*                      ! Values from Parton et al., 1987 and Whitmore and Parry, 1988
     ...
     >     cnwood      ! average c:n ratio for woody debris
      ...
      common /combgc1/lig_frac, fbsom, effac, cnr,fmax,rconst, cnleaf, cnroot, cnwood
...
c
     ...
     >          ksb           ! passive c         --> biomass
      ...
      common /combgc2/ klm, kls, kll, krm, krs, krl, kwm, kws, kwl, 
...
c
      common /combgc3/ ylm, yls, yll, yrm, yrs, yrl, ywm, yws, ywl, ybn,
     >                 ybp, ynb, yns, ypb, yps, ysb
